...
public class TypeTaskController {
    ...
    public ResponseEntity<TypeTaskModel> saveTypeTask(@RequestBody @Valid TypeTaskDto typeTaskDto) {
        var typeTaskModel = new TypeTaskModel();
    ...
    @GetMapping("/typeTask")
    public ResponseEntity<List<TypeTaskModel>> getAllTypeTask() {
    ...
    public ResponseEntity<Object> getOneTypeTask(@PathVariable(value = "id") String id) {
        Optional<TypeTaskModel> typeTaskSelected = typeTaskRepository.findById(id);
