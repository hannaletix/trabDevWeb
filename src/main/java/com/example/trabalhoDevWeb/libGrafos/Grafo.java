package com.example.trabalhoDevWeb.libGrafos;
...
public class Grafo<TIPO> {
    ...
    public void adicionarVertice(Vertice<TIPO> vertice) {
        // Verifica se já existe um vértice com o mesmo dado
        if (getVertice(vertice.getDado()) == null) {
            // Adiciona o vértice ao grafo associando ao idGrafo da entidade correspondente
            this.vertices.add(vertice);
        } else {
            System.out.println("Já existe um vértice com o dado " + vertice.getDado());
        }
    }
    ...
    public Vertice<TIPO> getVertice(TIPO dado){ //busca por vertice
        ...
        if (vertice == null) {
            System.out.println("Vértice não encontrado para dado: " + dado);
        }
